...
A working skeleton of the Rainbird VSCode extension proposed in [`../PROPOSAL.md`](../PROPOSAL.md). It demonstrates the MVP tier end-to-end: RBLang language support and a live query loop against the real Decisions API.
